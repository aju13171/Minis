...
if(clau_graph2): graficador("Input V_angular", 2, [-1,1],[lenta_neg,clau11(0.6,75),hipo11(0.6,75)])
if(clau_graphT2): graficador("Output V_angular",2, [-1,1],[clau7(0.6,75),clau8(0.6,75),clau9(0.6,75),clau10(0.6,75),clau11(0.6,75)])
#print(clau11) #test
